...
namespace BingLibrary.Vision.Calibrates
{
    ...
    /// 九点标定
    /// </summary>
    public static class NinePointCalibrate
    {
        /// <summary>
        /// 生成9点标定矩阵
        /// </summary>
        ...
        /// <returns></returns>
        public static HHomMat2D CalibrateNine(List<double> pixelX, List<double> pixelY, List<double> worldX, List<double> worldY)
        {
        ...
        /// <returns></returns>
        public static HHomMat2D CalibrateNineWithRotate(List<double> pixelX, List<double> pixelY, List<double> worldX, List<double> worldY, List<double> pixelXC, List<double> pixelYC)
        {
            HHomMat2D hHomMat2D = new HHomMat2D();
            try
            {
                HHomMat2D hHomMat2DFirst = CalibrateNine(pixelX, pixelY, worldX, worldY);
                (double x, double y, double r) circle = FitCircleToPoints(pixelXC, pixelYC);
                double cX = hHomMat2DFirst.AffineTransPoint2d(circle.x, circle.y, out double cY);
                ...
                hHomMat2D = CalibrateNine(pixelX, pixelY, newWorldX, newWorldY);
            }
            catch { }
            return hHomMat2D;
        }
